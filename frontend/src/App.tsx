  ...
  return (
    <div className="premium-layout">
      ...
      <div className="mobile-header">
        <div className="mobile-brand"><span className="brand-mark"><img src="/app-icon.svg" alt="" aria-hidden="true" /></span><div><h2 className="mobile-header-title">Tebuireng</h2><small>Sistem Kepesantrenan</small></div></div>
      ...
      <div className={`premium-sidebar ${isMobileMenuOpen ? 'open' : ''}`}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
          <div className="sidebar-brand"><span className="brand-mark"><img src="/app-icon.svg" alt="" aria-hidden="true" /></span><div><h2 className="sidebar-title">Tebuireng</h2><p>Sistem Kepesantrenan</p></div></div>
